...
These models, though approaching different problems in different ways, can be compared to each other in terms of our current work. In Table \ref{tab:model-comparison} we contrast and compare the features of these computational models
\begin{table}[h]
    \centering
    \begin{tabular}{rcccccc}
        \multicolumn{1}{r|}{}                 & Li       & Penacchio                       & Itti             & Zhang           & Spitzer         & Connolly \\ \cline{1-7}
