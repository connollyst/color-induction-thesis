...
We present a computational model designed to be representitive of the aforementioned biology of the striate cortex (V1). This can be conceived of as two distinct challenges:
\begin{enumerate}
    \item The transformation of raw image data to a biologically meaningful representation of information.
    \item The dynamical processing of this information in accordance with neurobiological understanding.
\end{enumerate}
...
\subsection{Neuro-Dynamical Processing}

\textit{TODO} How does V1 process the data?
\begin{itemize}
