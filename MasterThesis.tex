...
\begin{figure}[h] \label{fig:test-circles}
    ...
    \end{subfigure}
    \caption{Test images used to evaluate performance. In each image, the inner ring is the exact same physical color (same pixel values)} though we perceive them as different. The perceived color is defined by the true color of the ring, the color(s) of the surrounding ring(s), and the interaction between them all.
\end{figure}
