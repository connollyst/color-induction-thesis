...
As in Penacchio \cite{otazu:plosone}, we decompose the input signal into signal at different scales. This confers a level of scale invariance to the model.
