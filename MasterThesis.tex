...
\begin{table}[H] \label{tab:model-comparison}
    ...
    \begin{tabular}{rccccccc}
        \multicolumn{1}{r|}{}             & Proposed Model             & Penacchio \cite{penacchio:2013} & Li \cite{li:1999} & Itti \cite{itti:1998} & Yang \cite{yang:2013} & Spitzer \cite{spitzer:2005} & Zhang \cite{zhang:2012} \\ \cline{1-8}
        \multicolumn{1}{r|}{Dynamical}    & Y                          & Y                               & Y                 & Y                     & N                     & N                           & N                       \\
        ...
        \multicolumn{1}{r|}{SO RF}        & Gaussian / DWT             & N/A                             & N/A               & Gaussian Pyramid      & Gaussian              & Gaussian                    & None                    \\
        \multicolumn{1}{r|}{DO RF}        & Gabor-like Gaussians / DWT & DWT                             & N/A               & Gabor Pyramid         & Gabor-like Gaussians  & Gabor                       & None                    \\
        \multicolumn{1}{r|}{Goal}         & Color Induction            & Brightness Induction            & Saliency          & Saliency              & Edge Detection        & Color Induction             & Color Descriptor                     
    \end{tabular}
    \begin{tablenotes}
