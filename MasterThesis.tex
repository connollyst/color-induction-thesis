...
These derived color components (and intensity) are computed for a set of images convoluted in a \textit{Gaussian pyramid} and contrasted across scales to obtain center/surround opponent color (and intensity) channels:
...
\begin{table}[H] \label{tab:model-comparison}
    ...
    \begin{tabular}{rcccccc}
        ...
        \multicolumn{1}{r|}{Dynamical}    & Y                & Y                               & Y                 & Y                     & N                       & N               \\
