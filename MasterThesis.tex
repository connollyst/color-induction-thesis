...
\begin{figure}[H] \label{fig:so-rf-schematic}
    ...
    \begin{subfigure}{0.3\textwidth}
        ...
        \begin{tikzpicture}
            ...
            \draw[color=pomegranate!80, very thick] ( 1.00, 0.00) .. controls ( 0.30, 0.05) .. ( 0.05, 2.00)
                 node[color=black, anchor=south west] {$R_{\text{on}}$};
            % OFF Surround
            ...
            \draw[color=greensea,       very thick] ( 1.00, 0.00) .. controls ( 0.30,-0.05) .. ( 0.05,-2.00)
                 node[color=black, anchor=north west] {$G_{\text{off}}$};
    ...
    \begin{subfigure}{0.3\textwidth}
        ...
        \begin{tikzpicture}
            ...
            \draw[color=greensea,       very thick] ( 0.00, 0.00) .. controls (-0.70,-0.05) .. (-0.95,-2.00)
                 node[color=black, anchor=north west] {$G_{\text{on}}$};
            % ON Center
            \draw[color=greensea,       very thick] ( 0.00, 0.00) .. controls ( 0.70, 0.05) .. ( 0.95, 2.00);
            \draw[color=greensea,       very thick] ( 1.05, 2.00) .. controls ( 1.00, 2.10) .. ( 0.95, 2.00);
            \draw[color=greensea,       very thick] ( 2.00, 0.00) .. controls ( 1.30, 0.05) .. ( 1.05, 2.00)
                 node[color=black, anchor=south west] {$G_{\text{on}}$};
            % OFF Surround
            \draw[color=pomegranate!80, very thick] ( 0.00, 0.00) .. controls ( 0.70,-0.05) .. ( 0.95,-2.00);
            \draw[color=pomegranate!80, very thick] ( 1.05,-2.00) .. controls ( 1.00,-2.10) .. ( 0.95,-2.00);
            \draw[color=pomegranate!80, very thick] ( 2.00, 0.00) .. controls ( 1.30,-0.05) .. ( 1.05,-2.00)
                 node[color=black, anchor=north west] {$R_{\text{on}}$};
            % Reference line & point
...
\begin{figure}[h] \label{fig:rf-workflow}
    ...
    % RGB Input
    \draw ( -4.0,  25) node(r)[draw, shape=rectangle, minimum height=1.5cm, minimum width=2cm, align=center] {L Channel};
    \draw (  0.0,  25) node(g)[draw, shape=rectangle, minimum height=1.5cm, minimum width=2cm, align=center] {M Channel};
    \draw (  4.0,  25) node(b)[draw, shape=rectangle, minimum height=1.5cm, minimum width=2cm, align=center] {S Channel};
    ...
    % Colors
    \draw (-16.25,  0) node(L)[shape=rectangle, minimum height=1cm, align=center] {Light};
    \draw ( -9.75,  0) node(D)[shape=rectangle, minimum height=1cm, align=center] {Dark};
    \draw ( -3.25,  0) node(R)[shape=rectangle, minimum height=1cm, align=center] {Red};
    \draw (  3.25,  0) node(G)[shape=rectangle, minimum height=1cm, align=center] {Green};
    \draw (  9.75,  0) node(B)[shape=rectangle, minimum height=1cm, align=center] {Blue};
    \draw ( 16.25,  0) node(Y)[shape=rectangle, minimum height=1cm, align=center] {Yellow};
    ...
    \node[below of=Lso, node distance=2in] (Ldo) {
        \begin{tikzpicture}
            % ON Center
    ...
    \node[below of=Dso, node distance=2in] (Ddo) {
        \begin{tikzpicture}
            % ON Center
            \draw[pomegranate!80, very thick] (-2.00, 0.00) .. controls (-1.30, 0.05) .. (-1.05, 2.00);
            \draw[pomegranate!80, very thick] (-1.05, 2.00) .. controls (-1.00, 2.10) .. (-0.95, 2.00);
    ...
    \node[below of=Rso, node distance=2in] (Rdo) {
        \begin{tikzpicture}
            % ON Center
            \draw[pomegranate!80, very thick] (-2.00, 0.00) .. controls (-1.30, 0.05) .. (-1.05, 2.00);
            \draw[pomegranate!80, very thick] (-1.05, 2.00) .. controls (-1.00, 2.10) .. (-0.95, 2.00);
    ...
    \node[below of=Gso, node distance=2in] (Gdo) {
        \begin{tikzpicture}
            % ON Center
            \draw[pomegranate!80, very thick] (-2.00, 0.00) .. controls (-1.30, 0.05) .. (-1.05, 2.00);
            \draw[pomegranate!80, very thick] (-1.05, 2.00) .. controls (-1.00, 2.10) .. (-0.95, 2.00);
    ...
    \node[below of=Bso, node distance=2in] (Bdo) {
        \begin{tikzpicture}
            % ON Center
    ...
    \node[below of=Yso, node distance=2in] (Ydo) {
        \begin{tikzpicture}
            % ON Center
            \draw[pomegranate!80, very thick] (-2.00, 0.00) .. controls (-1.30, 0.05) .. (-1.05, 2.00);
            \draw[pomegranate!80, very thick] (-1.05, 2.00) .. controls (-1.00, 2.10) .. (-0.95, 2.00);
