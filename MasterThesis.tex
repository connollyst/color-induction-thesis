...
\subsubsection{Non-opponent Neurons}
...
\subsubsection{Single Opponent Neurons}
...
\subsubsection{Double Opponent Neurons}
...
\subsection*{Biology State of the Art Notes:}
\begin{enumerate}
    \item What is color?
        \begin{itemize}
            \item Subjective
...
This model is an extension of that presented by Penacchio \textit{et al.} \cite{otazu:plosone}, itself based on work by Z. Li \cite{li:1998, li:1999}.


\subsubsection*{Li's Neurodynamical Model for Segmentation}
...
\subsubsection*{Penacchio, Otazu, and Dempere-Marco's Neurodynamical Model for Brightness Induction}
Li's work laid the foundation for Penacchio \textit{et al.}, who extended the model to..

\subsection*{Computational Modeling State of the Art Notes:}
\begin{itemize}
    \item Z. Li 199
    \begin{itemize}
...
To investigate the nature of visual information representation and processing in the primate visual cortex (V1) we consider a biologically inspired computational model. 
