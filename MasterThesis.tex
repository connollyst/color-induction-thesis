...
\begin{figure}[h] \label{fig:bowtie-excite-maps}
    ...
    \begin{subfigure}[b]{0.2\textwidth}
            ...
            \caption{Vertical \& Non-Oriented}
    \end{subfigure}%
    \par \bigskip
    \begin{subfigure}[b]{0.2\textwidth}
            \centering
            \includegraphics[width=.85\linewidth]{j_2_1}
            \caption{Diagonal \& Vertical}
    \end{subfigure}%
    \begin{subfigure}[b]{0.2\textwidth}
            \centering
    ...
    \begin{subfigure}[b]{0.2\textwidth}
            ...
            \caption{Diagonal \& Horizontal}
    \end{subfigure}%
    \begin{subfigure}[b]{0.2\textwidth}
            \centering
            \includegraphics[width=.85\linewidth]{j_2_4}
            \caption{Diagonal \& Non-Oriented}
    \end{subfigure}%
    \par \bigskip
    \begin{subfigure}[b]{0.2\textwidth}
            \centering
    ...
    \begin{subfigure}[b]{0.2\textwidth}
            ...
            \caption{Horizontal \& Non-Oriented}
    \end{subfigure}%
    \par \bigskip
    \begin{subfigure}[b]{0.2\textwidth}
            \centering
            \includegraphics[width=.85\linewidth]{j_4_1}
            \caption{Non-Oriented \& Vertical}
    \end{subfigure}%
    \begin{subfigure}[b]{0.2\textwidth}
            \centering
            \includegraphics[width=.85\linewidth]{j_4_2}
            \caption{Non-Oriented \& Diagonal}
    \end{subfigure}%
    \begin{subfigure}[b]{0.2\textwidth}
            \centering
            \includegraphics[width=.85\linewidth]{j_4_3}
            \caption{Non-Oriented \& Horizontal}
    \end{subfigure}
    \begin{subfigure}[b]{0.2\textwidth}
            \centering
            \includegraphics[width=.85\linewidth]{j_4_4}
            \caption{Non-Oriented \& Non-Oriented}
    \end{subfigure}%
    \caption{Graphical representation of \textit{excitatory} interaction weights between vertical, diagonal, and horizontal double-opponent cells.}
\end{figure}
...
\begin{figure}[h] \label{fig:bowtie-excite-maps}
    ...
    \begin{subfigure}[b]{0.2\textwidth}
            ...
            \caption{Non-Oriented \& Non-Oriented}
    \end{subfigure}%
    \caption{Graphical representation of \textit{inhibitory} interaction weights between }
\end{figure}
