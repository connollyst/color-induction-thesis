...
\usepackage{color}
\definecolor{sunset}{rgb}{0.96, 0.28, 0.28}
\definecolor{gossip}{rgb}{0.54, 0.83, 0.48}
...
\begin{figure}[H]
    ...
    \subfloat[Symmetric Imbalanced]{\includegraphics[width=160pt]{rf_so_2}}
...
\begin{picture}(5,10)(0,-5)
    \thicklines
    % Upper Gaussian
    \color{sunset}
    \qbezier(0,0)(1,0)(1.25,2)
    \qbezier(1.25,2)(1.5,3.5)(1.75,2)
    \qbezier(1.75,2)(2,0)(3,0)
    % Lower Gaussian
    \color{gossip}
    \qbezier(0,0)(1,0)(1.25,-2)
    \qbezier(1.25,-2)(1.5,-3.5)(1.75,-2)
...
\begin{picture}(5,10)(0,-5)
    ...
    % Lower Gaussian
    \color{gossip}
    \qbezier(0,0)(1,0)(1.25,-0.75)
    \qbezier(1.25,-0.75)(1.5,-1)(1.75,-0.75)
    \qbezier(1.75,-0.75)(2,0)(3,0)
    \color{black}
    \put(0,0){\line(1,0){3}}
\end{picture}}
\end{figure}
...
\begin{tikzpicture}
    \filldraw[blue, very thick]                        (0.0,0.0) rectangle (3, 2);
    \filldraw[color=red!60,   fill=red!5,   very thick](0.0,0.7) ellipse   (1 and 0.3);
    \filldraw[color=green!60, fill=green!5, very thick](0.0,0.0) ellipse   (1 and 0.3);
\end{tikzpicture}
...
\begin{figure}[H]
    ...
    \subfloat[Symmetric Imbalanced]{\includegraphics[width=160pt]{rf_do_2}}
