...
\begin{figure}[h] \label{fig:test-bars}
    \centering
    \includegraphics[width=.5\textwidth]{test-circle-neon}
    \caption{Test image used to evaluate performance. In each image, the inner ring on the left is the exact same physical color (same pixel values) as the inner ring on the right.}
\end{figure}
