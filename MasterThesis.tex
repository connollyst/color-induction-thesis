...
\begin{figure}[H]
    \centering
    \subfloat[Symmetric Balanced]  {\includegraphics[width=100pt]{example_1a}}
    ~
    \subfloat[Symmetric Unbalanced]{\includegraphics[width=100pt]{example_1b}}
    ~
    \subfloat[Center/Surround]     {\includegraphics[width=100pt]{example_1c}}
    ~
    \subfloat[Center/Surround]     {\includegraphics[width=100pt]{example_1d}}
