...
\subsection*{Yang, Gao, Li \& Li's Model of Boundary Detection (2013)}
\begin{itemize}
    \item Single \& double-opponent color transformations using receptive fields
    \item Center \& surround receptive fields
    \item \textit{No dynamical processing}
...
\begin{table}[H] \label{tab:model-comparison}
    ...
    \begin{tabular}{rccccccc}
        \multicolumn{1}{r|}{}             & Proposed Model             & Penacchio \cite{penacchio:2013} & Li \cite{li:1999} & Yang \cite{yang:2013} & Itti \cite{itti:1998} & Spitzer \cite{spitzer:2005} & Zhang \cite{zhang:2012} \\ \cline{1-8}
        \multicolumn{1}{r|}{Dynamical}    & Y                          & Y                               & Y                 & Y                     & Y                     & N                           & N                       \\
        \multicolumn{1}{r|}{Colors}       & Y                          & N                               & N                 & Y                     & Y                     & Y                           & Y                       \\
        \multicolumn{1}{r|}{Scales}       & Y                          & Y                               & N                 & Y                     & Y                     & N                           & N                       \\
        \multicolumn{1}{r|}{Orientations} & Y                          & Y                               & Y                 & Y                     & Y                     & N                           & N                       \\
        \multicolumn{1}{r|}{SO}           & Y                          & N                               & N                 & Y                     & Y                     & Y                           & Y                       \\
        \multicolumn{1}{r|}{DO}           & Y                          & Y \textit{(achromatic)}         & N                 & Y                     & Y                     & Y                           & Y                       \\
        \multicolumn{1}{r|}{SO RF}        & Gaussian / DWT             & N/A                             & N/A               & Gaussian              & Gaussian Pyramid      & Gaussian                    & None                    \\
        \multicolumn{1}{r|}{DO RF}        & Gabor-like Gaussians / DWT & DWT                             & N/A               & Gabor-like Gaussians  & Gabor Pyramid         & Gabor                       & None                    \\
        \multicolumn{1}{r|}{Goal}         & Color Induction            & Brightness Induction            & Saliency          & Edge Detection        & Saliency              & Color Induction             & Color Descriptor                     
    \end{tabular}
    \begin{tablenotes}
