...
\begin{table}
    ...
    \begin{tabular}{rcccccc}
        \multicolumn{1}{r|}{}                 & Proposed Model        & Li \cite{li:1999}     & Penacchio \cite{otazu:plosone} & Itti \cite{itti:1999} & Zhang \cite{zhang:2012} & Spitzer \cite{spitzer:2005} \\ \cline{1-7}
