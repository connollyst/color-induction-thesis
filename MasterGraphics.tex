...
\begin{figure}[h]
    ...
    \begin{subfigure}{0.3\textwidth}
        \centering
        \begin{tikzpicture}
            \filldraw[color=alizarin!90,    fill=alizarin!70,  very thick]( 0.37, 0.00) ellipse   (0.33 and 0.90);
            \filldraw[color=greensea!80,    fill=turquoise!70, very thick](-0.37, 0.00) ellipse   (0.33 and 0.90);
