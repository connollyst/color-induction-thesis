...
\begin{figure}[h] \label{fig:rf-workflow}
    ...
    % RGB Input
    \draw ( -4.0,  20) node(r)[draw, shape=rectangle, minimum height=1.5cm, minimum width=2cm, align=center] {L Channel};
    \draw (  0.0,  20) node(g)[draw, shape=rectangle, minimum height=1.5cm, minimum width=2cm, align=center] {M Channel};
    \draw (  4.0,  20) node(b)[draw, shape=rectangle, minimum height=1.5cm, minimum width=2cm, align=center] {S Channel};
    % Gaussian Convolutions
    \draw ( -3.0,  15) node(c)[draw, shape=circle, text width=2cm, align=center] {CENTER \\ Convolution};
    \draw (  3.0,  15) node(s)[draw, shape=circle, text width=2cm, align=center] {SURROUND \\ Convolution};
