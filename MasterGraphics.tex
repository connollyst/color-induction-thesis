...
\begin{figure}[h]
    ...
    \end{subfigure}
    \caption{Schematic of various possible double-opponent receptive field configurations.}
\end{figure}
...
\begin{figure}[h]
    ...
    \end{subfigure}%
    \caption{Schematic of various possible single-opponent receptive field configurations.}
\end{figure}
