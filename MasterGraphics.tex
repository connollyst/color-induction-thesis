...
\begin{figure}[h] \label{fig:rf-workflow}
    ...
    \node[right of=B, node distance=1.75in] (Bso) {
        \begin{tikzpicture}
            % ON Center
            \draw[color=peter!80, very thick] (-1.00, 0.00) .. controls (-0.30, 0.05) .. (-0.05, 2.00);
            \draw[color=peter!80, very thick] (-0.05, 2.00) .. controls ( 0.00, 2.10) .. ( 0.05, 2.00);
            \draw[color=peter!80, very thick] ( 1.00, 0.00) .. controls ( 0.30, 0.05) .. ( 0.05, 2.00)
    ...
    \node[right of=Y, node distance=1.75in] (Yso) {
        \begin{tikzpicture}
            ...
            \draw[pomegranate!80, very thick] ( 1.00, 0.00) .. controls ( 0.30, 0.05) .. ( 0.05, 2.00)
                 node[color=black, anchor=south west] {$LM_{\text{on}}$};
            % OFF Surround
            \draw[color=peter,       very thick] (-1.50, 0.00) .. controls (-0.30,-0.20) .. (-0.05,-0.48);
            \draw[color=peter,       very thick] (-0.05,-0.48) .. controls ( 0.00,-0.49) .. ( 0.05,-0.48);
            \draw[color=peter,       very thick] ( 1.50, 0.00) .. controls ( 0.30,-0.20) .. ( 0.05,-0.48)
